...
import com.android.papp.adapters.recyleradapters.NotificationAdapter;
...
public class NotificationsFragment extends BaseFragment implements OnItemClickListener, OnItemAdd {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        adapter = new NotificationAdapter(getContext(), arrData, this);
    }
