...
import com.tekrevol.papp.adapters.recyleradapters.SessionPayoutHistoryAdapter;
...
public class SessionPayoutHistoryFragment extends BaseFragment implements OnItemClickListener, OnItemAdd {
    ...
    SessionPayoutHistoryAdapter adapter;
    ArrayList<SpinnerModel> arrData;


    public static SessionPayoutHistoryFragment newInstance() {

        Bundle args = new Bundle();

        SessionPayoutHistoryFragment fragment = new SessionPayoutHistoryFragment();
    ...
    public void setTitlebar(TitleBar titleBar) {
        ...
        titleBar.setTitle("Session Payout History");
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        adapter = new SessionPayoutHistoryAdapter(getContext(), arrData, this);
    }
