...
import com.tekrevol.papp.adapters.recyleradapters.MilestoneAdapter;
...
public class MilestoneFragment extends BaseFragment implements OnItemClickListener, OnItemAdd {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        adapter = new MilestoneAdapter(getContext(), arrData, this);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        txtHeading.setText("3 Badges Earned");
        ...
        arrData.clear();
        arrData.addAll(Constants.getMedalURL());
        adapter.notifyDataSetChanged();
    }
