...
package edu.aku.ehs.libraries.mpchart.charts;
...
import edu.aku.ehs.libraries.mpchart.animation.ChartAnimator;
import edu.aku.ehs.libraries.mpchart.animation.Easing;
import edu.aku.ehs.libraries.mpchart.components.Description;
import edu.aku.ehs.libraries.mpchart.components.IMarker;
import edu.aku.ehs.libraries.mpchart.components.Legend;
import edu.aku.ehs.libraries.mpchart.components.XAxis;
import edu.aku.ehs.libraries.mpchart.data.ChartData;
import edu.aku.ehs.libraries.mpchart.data.Entry;
import edu.aku.ehs.libraries.mpchart.formatter.DefaultValueFormatter;
import edu.aku.ehs.libraries.mpchart.formatter.IValueFormatter;
import edu.aku.ehs.libraries.mpchart.highlight.ChartHighlighter;
import edu.aku.ehs.libraries.mpchart.highlight.Highlight;
import edu.aku.ehs.libraries.mpchart.highlight.IHighlighter;
import edu.aku.ehs.libraries.mpchart.interfaces.dataprovider.ChartInterface;
import edu.aku.ehs.libraries.mpchart.interfaces.datasets.IDataSet;
import edu.aku.ehs.libraries.mpchart.listener.ChartTouchListener;
import edu.aku.ehs.libraries.mpchart.listener.OnChartGestureListener;
import edu.aku.ehs.libraries.mpchart.listener.OnChartValueSelectedListener;
import edu.aku.ehs.libraries.mpchart.renderer.DataRenderer;
import edu.aku.ehs.libraries.mpchart.renderer.LegendRenderer;
import edu.aku.ehs.libraries.mpchart.utils.MPPointF;
import edu.aku.ehs.libraries.mpchart.utils.Utils;
import edu.aku.ehs.libraries.mpchart.utils.ViewPortHandler;
import edu.aku.ehs.libraries.mpchart.animation.Easing.EasingFunction;
/**
