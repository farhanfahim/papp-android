...
import edu.aku.ehs.libraries.mpchart.interfaces.dataprovider.BarLineScatterCandleBubbleDataProvider;
import edu.aku.ehs.libraries.mpchart.interfaces.datasets.IBarLineScatterCandleBubbleDataSet;
import edu.aku.ehs.libraries.mpchart.jobs.AnimatedMoveViewJob;
import edu.aku.ehs.libraries.mpchart.jobs.AnimatedZoomJob;
import edu.aku.ehs.libraries.mpchart.jobs.MoveViewJob;
import edu.aku.ehs.libraries.mpchart.jobs.ZoomJob;
import edu.aku.ehs.libraries.mpchart.listener.BarLineChartTouchListener;
import edu.aku.ehs.libraries.mpchart.listener.OnDrawListener;
import edu.aku.ehs.libraries.mpchart.renderer.XAxisRenderer;
import edu.aku.ehs.libraries.mpchart.renderer.YAxisRenderer;
import edu.aku.ehs.libraries.mpchart.utils.MPPointD;
...
import edu.aku.ehs.libraries.mpchart.components.XAxis.XAxisPosition;
