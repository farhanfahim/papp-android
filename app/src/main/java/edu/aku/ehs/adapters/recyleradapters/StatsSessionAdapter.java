...
/**
 */
public class StatsSessionAdapter extends RecyclerView.Adapter<StatsSessionAdapter.ViewHolder> {
    ...
    public StatsSessionAdapter(BaseActivity activity, ArrayList<SessionModel> arrData, OnItemClickListener onItemClickListener) {
