...
public class EmailSelectionAdapter extends RecyclerView.Adapter<EmailSelectionAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int i) {
        ...
        if (StringHelper.isNullOrEmpty(model.getEmailAddress())) {
            holder.txtEmail.setVisibility(View.GONE);
//            holder.txtEmail.setText("dummy@aku.edu");
        } else {
        ...
        if (model.getStatusEnum() == EmployeeSessionState.SCHEDULED || model.getStatusEnum() == EmployeeSessionState.INPROGRESS) {
            ...
            holder.txDate.setVisibility(VISIBLE);
        } else {
...
//                hideOptions(holder);
        ...
        if (model.isSelected()) {
            ...
            AnimationHelper.fade(holder.imgSelected, 0, View.VISIBLE, VISIBLE, 1, 300);
