...
public class FamilyHistoryAssessmentFragment extends BaseFragment implements OnItemClickListener {
    ...
    public static FamilyHistoryAssessmentFragment newInstance() {

        Bundle args = new Bundle();

        FamilyHistoryAssessmentFragment fragment = new FamilyHistoryAssessmentFragment();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        txtQuestionTitle.setText("Family History");
        txtQuestionSubTitle.setText("Specific to Mother, Father, Brother and Sister");
    ...
    private void bindData() {
        ...
        for (String s : getBaseActivity().getResources().getStringArray(R.array.familyHistoryQuestions)) {
            model = new AssessmentQuestionModel(s, QuestionTypeEnum.FAMILYHISTORY);
            arrData.add(model);
        }
