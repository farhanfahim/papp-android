...
public class PsychosocialHistoryAssessmentFragment extends BaseFragment implements OnItemClickListener {
    ...
    public static PsychosocialHistoryAssessmentFragment newInstance() {

        Bundle args = new Bundle();

        PsychosocialHistoryAssessmentFragment fragment = new PsychosocialHistoryAssessmentFragment();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        txtQuestionTitle.setText("Psychosocial History");
        txtQuestionSubTitle.setText("Over the last 2 weeks, How often have you felt?");
    ...
    private void bindData() {
        ...
        for (String s : getBaseActivity().getResources().getStringArray(R.array.pschosocialHistoryQuestions)) {
            model = new AssessmentQuestionModel(s, QuestionTypeEnum.PSYCHOSOCIALHISTORY);
            arrData.add(model);
        }
