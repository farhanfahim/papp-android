...
public class SmokingBehaviorAssessmentFragment extends BaseFragment implements OnItemClickListener {
    ...
    public static SmokingBehaviorAssessmentFragment newInstance() {

        Bundle args = new Bundle();

        SmokingBehaviorAssessmentFragment fragment = new SmokingBehaviorAssessmentFragment();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        txtQuestionTitle.setText("Smoking Behaviors");
        txtQuestionSubTitle.setText("Kindly answer following Questions");
    ...
    private void bindData() {
        ...
        for (String s : getBaseActivity().getResources().getStringArray(R.array.smokingBehaviorsQuestions)) {
            model = new AssessmentQuestionModel(s, QuestionTypeEnum.SMOKINGBEHAVIOR);
            arrData.add(model);
        }
