...
public interface ThreadHandler {
    ...
    Completable grantAudioRecordAccess(Thread thread, User users, boolean grant);
    /**
    ...
    Completable deleteThreadPermanently(Thread thread);
    Completable makeAdminToEarliestPerson(Thread thread, String userId);
    ...
    Observable<Boolean> isGroupAdmin(Thread thread);
    Observable<Boolean> hasAudioAccess(Thread thread);
}
