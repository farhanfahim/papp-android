...
public class Thread implements CoreEntity {
    ...
    public Thread(Long id, String entityID, Date creationDate, Boolean hasUnreadMessages, Boolean deleted, String name, Integer type,
            String creatorEntityId, String imageUrl, String rootKey, String apiKey, Long creatorId, Long lastMessageId, boolean isAdmin) {
        this.id = id;
    ...
    public boolean isGroupAdmin() {
        return getCreatorEntityId().equals(ChatSDK.currentUser().getEntityID());
    }
