...
public class DaoCore {
    ...
    public static void deleteAll(Class<?> entityClass) {
    ...
    public static void connectUserAndThread(User user, Thread thread) {
        if (DEBUG)
            Timber.v("connectUserAndThread, CoreUser ID: %s, Name: %s, ThreadID: %s", +user.getId(), user.getName(), thread.getId());
    ...
    public static void breakUserAndThread(User user, Thread thread) {
        if (DEBUG)
            Timber.v("breakUserAndThread, CoreUser ID: %s, Name: %s, ThreadID: %s", +user.getId(), user.getName(), thread.getId());
    ...
    public static <T extends CoreEntity> T getEntityForClass(Class<T> c) {
