...
public class SelectedUsersListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SelectedUsersListAdapter() {
        this(null, false);
    }

    public SelectedUsersListAdapter(boolean isMultiSelect) {
        this(null, isMultiSelect);
    }

    public SelectedUsersListAdapter(List<UserListItem> users, boolean multiSelect) {
        if (users == null) {
            users = new ArrayList<>();
        }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_HEADER) {
            ...
            View row = inflater.inflate(R.layout.chat_sdk_selected_participant, null);
