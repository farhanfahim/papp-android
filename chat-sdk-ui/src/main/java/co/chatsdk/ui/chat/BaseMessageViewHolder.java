...
public class BaseMessageViewHolder extends AbstractMessageViewHolder {
    ...
    public BaseMessageViewHolder(View itemView, Activity activity) {
        ...
        lyt_voice_message = itemView.findViewById(R.id.lyt_voice_message);
        ...
        btn_view_ref = itemView.findViewById(R.id.btn_view_ref);
        btnPause = itemView.findViewById(R.id.btn_pause);
        seekbar = itemView.findViewById(R.id.seekbar);
        voiceProgressBar = itemView.findViewById(R.id.voice_progress_bar);
        tvDuration = itemView.findViewById(R.id.tv_duration);

        if(itemView.findViewById(R.id.tv_sender_name) != null) {
            senderName = itemView.findViewById(R.id.tv_sender_name);
            lytSenderDetail = itemView.findViewById(R.id.lyt_sender_detail);
        }
...
//            builder.show();
    ...
    public void setVoiceMessage(boolean isHidden) {
        lyt_voice_message.setVisibility(isHidden ? View.GONE : View.VISIBLE);
    ...
    public void setMessage (Message message) {
        ...
        if (message.getSender().isMe()) {
            ...
            if(message.getThread().getType() == ThreadType.PrivateGroup || message.getThread().getType() == ThreadType.PublicGroup ) {
                lytSenderDetail.setVisibility(View.VISIBLE);
                senderName.setText(message.getSender().getName());
            } else {
                lytSenderDetail.setVisibility(View.GONE);
            }
    ...
    public void showVoiceProgressBar() {
    ...
    public void showVoiceProgressBar(float progress) {
        if (progress == 0) {
            showVoiceProgressBar();
        }
        else {
            voiceProgressBar.setVisibility(View.VISIBLE);
            voiceProgressBar.setIndeterminate(false);
            voiceProgressBar.setMax(100);
            voiceProgressBar.setProgress((int) Math.ceil(progress * progressBar.getMax()));
            voiceProgressBar.bringToFront();
        }
    }
...
//        }
    ...
    public void setImageHidden (boolean hidden) {
        messageImageView.setVisibility(hidden ? View.GONE : View.VISIBLE);
        imageCardView.setVisibility(hidden ? View.GONE : View.VISIBLE);
